...
var handleStateChange = function handleStateChange(updatedState) {
  return socket.send(JSON.stringify(updatedState));
};

// render app with new state
var renderApp = function renderApp(state) {
  return (0, _reactDom.hydrate)(_react2.default.createElement(_app.App, { state: state, onStateChange: handleStateChange }), document.getElementById('app'));
};
...
var _sliderSwitch = __webpack_require__(28);
...
var App = exports.App = function App(_ref) {
  ...
  var onChangeHandler = function onChangeHandler(chan, value) {
    var returnedState = {};
  ...
  return _react2.default.createElement(
    'main',
    { style: STYLES },
    Object.keys(state).map(function (key, idx) {
      return _react2.default.createElement(_sliderSwitch.SliderSwitch, {
        key: key,
        text: key,
...
exports.SliderSwitch = undefined;
...
var _currentFeed = __webpack_require__(30);
...
var SliderSwitch = exports.SliderSwitch = function (_Component) {
  _inherits(SliderSwitch, _Component);

  function SliderSwitch(props) {
    _classCallCheck(this, SliderSwitch);

    var _this = _possibleConstructorReturn(this, (SliderSwitch.__proto__ || Object.getPrototypeOf(SliderSwitch)).call(this, props));
  ...
  _createClass(SliderSwitch, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'range', list: 'tickmarks', style: BASE_STYLES, min: '0', max: channel.total, value: channel.index, onChange: this.onChangeHandler }),
        _react2.default.createElement(_currentFeed.CurrentFeed, _extends({ text: text }, channel.resources))
      );
    }
  }, {
    key: 'onChangeHandler',
...
var Switch = exports.Switch = function Switch(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'c-switch', style: styles },
...
var CurrentFeed = exports.CurrentFeed = function CurrentFeed(_ref) {
  var _ref$text = _ref.text,
      text = _ref$text === undefined ? '' : _ref$text,
      _ref$thumbnailURL = _ref.thumbnailURL,
      thumbnailURL = _ref$thumbnailURL === undefined ? false : _ref$thumbnailURL,
      _ref$feedURL = _ref.feedURL,
      feedURL = _ref$feedURL === undefined ? false : _ref$feedURL;

  return _react2.default.createElement(
    'figure',
    { className: 'c-current-feed' },
    _react2.default.createElement(
      'figcaption',
      null,
      text
    ),
    thumbnailURL && _react2.default.createElement('img', { src: thumbnailURL }),
    feedURL && _react2.default.createElement('video', { src: feedURL, autoplay: true })
  );
};
